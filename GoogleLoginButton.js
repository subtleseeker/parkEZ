        ...
        return (
          <TouchableHighlight onPress={this.onLogin}  >
            {(this.state.status == false) ? 
              <Image source={require('./src/images/btn_google_signin_light_normal_web.png')}  />
              : <View style={[styles.button]}>
              <Image style={{shadowOpacity:0}} source={require('./src/images/btn_google_light_normal_ios.png')}  />
